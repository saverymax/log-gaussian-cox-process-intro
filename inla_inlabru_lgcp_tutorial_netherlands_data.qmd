...
summary(fit1)
```
$\beta_0$ is -17, which is quite low since the average baseline intensity $\frac{n_{obs}}{\text{Area_D}}$ is also very small. This is because there are not that many observations (2705) over the whole of the Netherlands.
